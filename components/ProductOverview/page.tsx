      ...
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            {productNew.discount ? (
              <>
                <p className="flex items-baseline mb-2 text-yellow-300">
                  Discount : {productNew.discount * 100}%
                </p>
                <span className=" text-l line-through">
                  ${productNew.price}
                </span>
                <span className="ml-2 text-red-500 text-2xl">
                  $
                  {(
                    productNew.price -
                    productNew.discount * productNew.price
                  ).toFixed(2)}
                </span>
              </>
            ) : (
